        ...
        <ResizablePanel defaultSize={50} minSize={30}>
          <div className="h-full flex items-center justify-center bg-background">
            <div className="text-center space-y-2">
              ...
              <p className="text-lg font-medium text-muted-foreground">Main content area</p>
              <p className="text-sm text-muted-foreground/70">Content will be displayed here</p>
            </div>
          </div>
        </ResizablePanel>
